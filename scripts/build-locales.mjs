...
for (const locale of locales) {
 ...
 const languageNames = { en: 'English', ja: '日本語', zh: '中文' };
 const languageLabel = { en: 'Language', ja: '言語', zh: '语言' }[locale];
